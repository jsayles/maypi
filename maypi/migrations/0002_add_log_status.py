...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CodeLog.status'
        db.add_column(u'maypi_codelog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='NONE', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CodeLog.status'
        db.delete_column(u'maypi_codelog', 'status')
    ...
    models = {
        ...
        u'maypi.codelog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'NONE'", 'max_length': '16'}),
